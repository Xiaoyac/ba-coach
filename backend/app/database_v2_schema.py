...
module_two_record = table("module_two_record", ident(primary=True),
    ...
    *status(["draft", "confirmed", "superseded"], name="record_status"),
    ...
    col("difficulty_rating", SmallInteger), col("difficulty_original", SmallInteger),
    col("difficulty_evidence", JSON),
    ...
    *status(["unconfirmed", "partially_confirmed", "confirmed", "rejected"], name="confirmation_status"),
    ...
    CheckConstraint("difficulty_rating IS NULL OR difficulty_rating BETWEEN 0 AND 10", name="ck_m2_difficulty_rating"),
    CheckConstraint("difficulty_original IS NULL OR difficulty_original BETWEEN 6 AND 10", name="ck_m2_difficulty_original"),
...
module_three_record = table("module_three_record", ident(primary=True),
    ...
    *status(["unknown", "accepted", "declined"], name="recording_status"),
    col("recording_evidence", JSON),
